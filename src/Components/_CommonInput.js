...
export default class CommonInput extends Component {
  ...
  componentDidMount() {
    ...
    if (typeof this.masksRegex !== 'object' || this.masksRegex.constructor.name !== 'RegExp')
    ...
    if (this.length === undefined)
      throw "O atributo `length` é obrigatório.";
    if (typeof this.length !== 'number')
      throw "O atributo `length` precisa ser um número inteiro.";
    if (this.pattern
      && (typeof this.pattern !== 'object' || this.pattern.constructor.name !== 'RegExp'))
